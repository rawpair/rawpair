...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------- |
| `RAWPAIR_STACKS_VERSION`  | Version of `stacks.json` to load from the [`rawpair/stacks`](https://github.com/rawpair/stacks) repository. Must match a Git tag or branch.      | `0.1.3`           |
